...
class ManipulatorPickPlace:
    ...
    def perform_pick_place_task(self):
        ...
        pose_aruco.pose.position.x = 0.1871
        pose_aruco.pose.position.y = -0.0017
        pose_aruco.pose.position.z = 0.0653

        pose_aruco.pose.orientation.x = 0.005423
        pose_aruco.pose.orientation.y = 0.707086
        pose_aruco.pose.orientation.z = -0.005423
        pose_aruco.pose.orientation.w = 0.707086
